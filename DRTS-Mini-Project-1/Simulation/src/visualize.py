...
def visualization(edf_trace_path: str, dm_trace_path: str, out_path: Optional[str] = None):
    ...
    if out_path is None:
        out_path = os.path.join(os.path.dirname(edf_trace_path), f"{base}_vizualization.png")
