...
from src.visualize import visualize_trace, visualization
...
def parse_args():
    ...
    parser.add_argument("mode", default="simulate", choices=["simulate", "gantt", "vizualize"], help="Mode: simulate or visualize")
...
def main():
    ...
    elif args.mode == "vizualize":
        out_path = visualization(args.trace_path, args.trace_path_2)
        print(f"Results written to {out_path}")
